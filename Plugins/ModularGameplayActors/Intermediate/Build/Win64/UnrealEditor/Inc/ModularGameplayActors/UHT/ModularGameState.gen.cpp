...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_ModularGameplayActors_Source_ModularGameplayActors_Public_ModularGameState_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AModularGameStateBase, AModularGameStateBase::StaticClass, TEXT("AModularGameStateBase"), &Z_Registration_Info_UClass_AModularGameStateBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AModularGameStateBase), 3304092157U) },
		{ Z_Construct_UClass_AModularGameState, AModularGameState::StaticClass, TEXT("AModularGameState"), &Z_Registration_Info_UClass_AModularGameState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AModularGameState), 413129837U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_ModularGameplayActors_Source_ModularGameplayActors_Public_ModularGameState_h_55372394(TEXT("/Script/ModularGameplayActors"),
	Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_ModularGameplayActors_Source_ModularGameplayActors_Public_ModularGameState_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_ModularGameplayActors_Source_ModularGameplayActors_Public_ModularGameState_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
