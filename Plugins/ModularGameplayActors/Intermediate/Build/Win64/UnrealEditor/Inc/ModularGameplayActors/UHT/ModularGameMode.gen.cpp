...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_ModularGameplayActors_Source_ModularGameplayActors_Public_ModularGameMode_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AModularGameModeBase, AModularGameModeBase::StaticClass, TEXT("AModularGameModeBase"), &Z_Registration_Info_UClass_AModularGameModeBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AModularGameModeBase), 2794467454U) },
		{ Z_Construct_UClass_AModularGameMode, AModularGameMode::StaticClass, TEXT("AModularGameMode"), &Z_Registration_Info_UClass_AModularGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AModularGameMode), 2403623874U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_ModularGameplayActors_Source_ModularGameplayActors_Public_ModularGameMode_h_1145685220(TEXT("/Script/ModularGameplayActors"),
	Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_ModularGameplayActors_Source_ModularGameplayActors_Public_ModularGameMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_ModularGameplayActors_Source_ModularGameplayActors_Public_ModularGameMode_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
