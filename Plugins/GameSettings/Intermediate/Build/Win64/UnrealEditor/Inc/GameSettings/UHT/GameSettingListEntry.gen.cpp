...
static const FName NAME_UGameSettingListEntryBase_GetPrimaryGamepadFocusWidget = FName(TEXT("GetPrimaryGamepadFocusWidget"));
UWidget* UGameSettingListEntryBase::GetPrimaryGamepadFocusWidget()
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UGameSettingListEntryBase_GetPrimaryGamepadFocusWidget);
...
static const FName NAME_UGameSettingListEntrySetting_Scalar_OnDefaultValueChanged = FName(TEXT("OnDefaultValueChanged"));
void UGameSettingListEntrySetting_Scalar::OnDefaultValueChanged(float DefaultValue)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UGameSettingListEntrySetting_Scalar_OnDefaultValueChanged);
	ProcessEvent(Func,&Parms);
}
...
static const FName NAME_UGameSettingListEntrySetting_Scalar_OnValueChanged = FName(TEXT("OnValueChanged"));
void UGameSettingListEntrySetting_Scalar::OnValueChanged(float Value)
{
	...
	Parms.Value=Value;
	UFunction* Func = FindFunctionChecked(NAME_UGameSettingListEntrySetting_Scalar_OnValueChanged);
	ProcessEvent(Func,&Parms);
}
...
static const FName NAME_UGameSettingListEntrySetting_Action_OnSettingAssigned = FName(TEXT("OnSettingAssigned"));
void UGameSettingListEntrySetting_Action::OnSettingAssigned(FText const& ActionText)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UGameSettingListEntrySetting_Action_OnSettingAssigned);
	ProcessEvent(Func,&Parms);
}
...
static const FName NAME_UGameSettingListEntrySetting_Navigation_OnSettingAssigned = FName(TEXT("OnSettingAssigned"));
void UGameSettingListEntrySetting_Navigation::OnSettingAssigned(FText const& ActionText)
{
	...
	Parms.ActionText=ActionText;
	UFunction* Func = FindFunctionChecked(NAME_UGameSettingListEntrySetting_Navigation_OnSettingAssigned);
	ProcessEvent(Func,&Parms);
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_GameSettings_Source_Public_Widgets_GameSettingListEntry_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UGameSettingListEntryBase, UGameSettingListEntryBase::StaticClass, TEXT("UGameSettingListEntryBase"), &Z_Registration_Info_UClass_UGameSettingListEntryBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameSettingListEntryBase), 3369557488U) },
		{ Z_Construct_UClass_UGameSettingListEntry_Setting, UGameSettingListEntry_Setting::StaticClass, TEXT("UGameSettingListEntry_Setting"), &Z_Registration_Info_UClass_UGameSettingListEntry_Setting, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameSettingListEntry_Setting), 3040419023U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_GameSettings_Source_Public_Widgets_GameSettingListEntry_h_369936568(TEXT("/Script/GameSettings"),
	Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_GameSettings_Source_Public_Widgets_GameSettingListEntry_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_GameSettings_Source_Public_Widgets_GameSettingListEntry_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
