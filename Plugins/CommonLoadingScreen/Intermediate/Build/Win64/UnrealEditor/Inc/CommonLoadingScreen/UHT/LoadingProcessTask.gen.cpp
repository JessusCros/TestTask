...
struct Z_Construct_UClass_ULoadingProcessTask_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_ULoadingProcessTask_CreateLoadingScreenProcessTask, "CreateLoadingScreenProcessTask" }, // 597290332
		{ &Z_Construct_UFunction_ULoadingProcessTask_SetShowLoadingScreenReason, "SetShowLoadingScreenReason" }, // 2190313329
		{ &Z_Construct_UFunction_ULoadingProcessTask_Unregister, "Unregister" }, // 1806293128
	};
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ULoadingProcessTask_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_ULoadingProcessInterface_NoRegister, (int32)VTABLE_OFFSET(ULoadingProcessTask, ILoadingProcessInterface), false },  // 3535459782
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_CommonLoadingScreen_Source_CommonLoadingScreen_Public_LoadingProcessTask_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ULoadingProcessTask, ULoadingProcessTask::StaticClass, TEXT("ULoadingProcessTask"), &Z_Registration_Info_UClass_ULoadingProcessTask, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULoadingProcessTask), 130069480U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_CommonLoadingScreen_Source_CommonLoadingScreen_Public_LoadingProcessTask_h_1509387769(TEXT("/Script/CommonLoadingScreen"),
	Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_CommonLoadingScreen_Source_CommonLoadingScreen_Public_LoadingProcessTask_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Work_DebugLyraStarterGame_Plugins_CommonLoadingScreen_Source_CommonLoadingScreen_Public_LoadingProcessTask_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
